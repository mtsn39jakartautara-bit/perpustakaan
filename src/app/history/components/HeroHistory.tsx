...
const HeroHistory = () => {
  return (
    <div
      className="relative h-[50vh] bg-gradient-hero flex items-center justify-center overflow-hidden"
      style={{
    ...
    >
      ...
      >
        ...
        <div className="absolute top-1/2 left-1/4 w-10 h-10 bg-white/10 rounded-full"></div>
      </motion.div>
      ...
      >
        ...
        <p className="text-lg md:text-xl text-cream/90 max-w-2xl mx-auto">
          Lacak semua buku yang pernah Anda pinjam dari perpustakaan MTsN 39
        </p>
      </motion.div>
    </div>
  );
