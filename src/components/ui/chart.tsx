...
type ChartTooltipContentProps = React.ComponentProps<"div"> & {
  ...
  label?: any;
  labelFormatter?: (label: any, payload?: AnyPayloadItem[]) => React.ReactNode;
...
>(
  (
    ...
    const tooltipLabel = React.useMemo(() => {
      if (hideLabel || payloadArray.length === 0) return null;
    ...
    if (!active || payloadArray.length === 0) return null;
    ...
    return (
      ...
      >
        ...
        <div className="grid gap-1.5">
          {payloadArray.map((item: AnyPayloadItem, index: number) => {
  ...
  (
    ...
    return (
      <div
        ...
        {...rest}
      >
        {payloadArray.map((item: AnyPayloadItem, idx: number) => {
